...
@magic_arguments.argument(
    "-f", "--filenames", type=str, help="file(s) of testcase", nargs="*"
)
@magic_arguments.argument("-u", "--url", type=str, help="url of testcase")
@magic_arguments.argument(
    "-s",
    "--save_file_name",
    type=str,
    default=None,
    help="prefix of name of file to save test cases got from url",
)
@magic_arguments.argument("content", type=str, help="file(s) or url", nargs="*")
@register_cell_magic
